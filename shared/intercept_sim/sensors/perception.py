...
from intercept_sim.types import CameraCapture, ImageFeatureMeasurement
...
class FeaturePerceptionModel:
    ...
    # If set (typically [1/fx_px, 1/fy_px]), the same pixel noise sample applied to
    # uv_px is converted into normalized-image-coord noise and added to uv_norm.
    # Without this, downstream observers (which consume uv_norm) see noise-free
    # image data even when pixel_noise_std_px is non-zero.
